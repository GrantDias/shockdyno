 ...
 *
 *  Filename:        rt_isr_arduino_uno_v1_1.ino
...
ISR(TIMER1_COMPA_vect)
{
  ...
  Serial.print(ana_in_value);          // Plot the raw analog input value to the Serial Plotter
  Serial.print(",");                   // separator
  Serial.print((int)control_out);      // Plot the control output value to the Serial Plotter
  Serial.print(",");                   // separator
